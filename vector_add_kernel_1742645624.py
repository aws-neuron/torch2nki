...
def vector_add_kernel(v1, v2):
    ...
    # Create an output tensor of shape (size,) in HBM without initialization
    result = nl.zeros((size,), dtype=v1.dtype, buffer=nl.hbm)  # Correctly allocate in HBM without initialization value
