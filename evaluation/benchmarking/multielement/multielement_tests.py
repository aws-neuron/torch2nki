...
def main():
    ...
    test_results['softmax'] = test_torch_softmax(device)
    test_results['log_softmax'] = test_torch_log_softmax(device)
    test_results['max'] = test_torch_max(device)
    test_results['min'] = test_torch_min(device)
    test_results['sum'] = test_torch_sum(device)
    test_results['mean'] = test_torch_mean(device)
    test_results['var'] = test_torch_var(device)
    test_results['std'] = test_torch_std(device)
    test_results['norm'] = test_torch_norm(device)
    test_results['cumsum'] = test_torch_cumsum(device)
    test_results['cumprod'] = test_torch_cumprod(device)
    test_results['prod'] = test_torch_prod(device)
    test_results['round'] = test_torch_round(device)
    test_results['floor'] = test_torch_floor(device)
    test_results['ceil'] = test_torch_ceil(device)
    test_results['trunc'] = test_torch_trunc(device)
    test_results['sign'] = test_torch_sign(device)
    test_results['where'] = test_torch_where(device)
    test_results['eq'] = test_torch_eq(device)
    test_results['ne'] = test_torch_ne(device)
    test_results['gt'] = test_torch_gt(device)
    test_results['lt'] = test_torch_lt(device)
    test_results['clamp'] = test_torch_clamp(device)
    test_results['sort'] = test_torch_sort(device)
    test_results['topk'] = test_torch_topk(device)
    test_results['kthvalue'] = test_torch_kthvalue(device)
    test_results['median'] = test_torch_median(device)
    test_results['mode'] = test_torch_mode(device)
    test_results['percentile'] = test_torch_percentile(device)
    test_results['logsumexp'] = test_torch_logsumexp(device)
    test_results['amax'] = test_torch_amax(device)
    test_results['amin'] = test_torch_amin(device)
    test_results['all'] = test_torch_all(device)
    test_results['any'] = test_torch_any(device)
    test_results['bincount'] = test_torch_bincount(device)
    test_results['unique'] = test_torch_unique(device)
    test_results['unique_consecutive'] = test_torch_unique_consecutive(device)
