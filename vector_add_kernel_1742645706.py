...
def vector_add_kernel(v1, v2):
    ...
    # Create an output tensor of shape (size,) in SBUF (initialized with zeros)
    result = nl.zeros((size,), dtype=v1.dtype, buffer=nl.sbuf)  # Allocate in SBUF filled with zeros
