...
def vector_add_kernel(v1, v2):
    ...
    # Create the output tensor explicitly by using zeros_like to ensure it matches the shape and dtype of v1
    result = nl.zeros_like(v1)  # Ensure it matches the shape and dtype of v1
